-- ============================================================
-- W1: Wire outcome_classification through record_call_attempt
--
-- Phase D (20260613110000_outcome_model.sql) added the
-- outcome_classification column to call_attempts but did not
-- update record_call_attempt to write it. That left the column
-- dead — every report view that exposes outcome_classification
-- always returned NULL.
--
-- This migration replaces the 21-arg signature with a 22-arg
-- signature that accepts p_outcome_classification and writes it
-- into the call_attempts row. Existing callers that omit the
-- new parameter pick up the NULL default, preserving behaviour.
-- ============================================================
