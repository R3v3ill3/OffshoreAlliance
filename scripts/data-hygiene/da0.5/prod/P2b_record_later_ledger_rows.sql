-- DA0.5 PRODUCTION RUN SHEET — step P2b (mutating: two ledger rows)
...
-- What it does: inserts the rows ('20260923220000','mobilisation_recipients') and ('20260924010000','mobilisation_signal_schedule') into supabase_migrations.schema_migrations (their objects are already live on production) and two audit rows. Changes nothing else. Refuses to run twice.
-- Expect: rows_20260923220000 1, rows_20260924010000 1, ledger_rows 19, ledger_max_version 20260924010000, recipients_table t, recipients_policies 2, signals_new_columns 2, arrival_index t, log_rows_written 2.
