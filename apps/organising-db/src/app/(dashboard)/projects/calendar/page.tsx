...
import { MobilisationCalendar } from "@/app/(dashboard)/mobilisation/_components/calendar-grid";
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Estimated arrival, and the length of stay when a source states it. A label opens that item in Alerts.
