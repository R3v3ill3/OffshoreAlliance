-- DA0.3 PRODUCTION RUN SHEET — step P1 (read-only)
...
-- What it does: one row of counts, checksums and object presence; changes nothing.
-- Expect: employers_n 187 and worksites_n 194 (with their md5s), employer aliases merge 39, worksite aliases import 8, DA0.3 objects absent (has_nmr f, no fold_name / decide_name_match), workers with raw columns 0, both alias CHECKs at their old vocabularies, ledger_max_version 20260922040000 (after DA0.5 P2; 20260921030000 if DA0.5 has not run yet).
