...
| P2 | `P2_record_ledger_row.sql` | mutating (one ledger row + one audit row) | `ledger_row_present t … ledger_rows 17 … policies 29 (27 radar + 2 recipients) … log_rows_written 1` |
