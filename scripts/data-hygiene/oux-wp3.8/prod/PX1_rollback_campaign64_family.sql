-- WP3.8 PRODUCTION RUN SHEET — recovery only: reverse P4
...
-- What it does: clears the three parent links and sets 88–92 back to scope = campaign; logs the reversal. Only after P4, only if asked.
-- Expect: a result row with children_of_64_after 0 and family_on_64_after 0.
