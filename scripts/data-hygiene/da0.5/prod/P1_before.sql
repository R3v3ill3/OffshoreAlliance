-- DA0.5 PRODUCTION RUN SHEET — step P1 (read-only)
...
-- What it does: one row of catalog counts, the ledger state and the employer-register reconciliation; changes nothing.
-- Expect: tables_present 16, columns_n 173, constraints_n 72, indexes_n 34, policies_n 27, triggers_n 8, audit_function_md5 764235c6343f9cc8189502ba271571e5, recipients_table t, recipients_policies 2, signals_new_columns 2, mobilisation_ledger_rows NULL, ledger_max_version 20260921030000, ledger_rows 16, vessels 25 / 3 / 0 / 0, contractors 14 / 2 / 0 / 0, alias_strings_missing_from_register 4 (measured on production 2026-09-24)
