...
| Run the Phase 0 production run sheets in the order DA0.2 → DA0.5 → DA0.3 (ready-to-paste files under each package's `prod/` folder; one file per submission, the one result row pasted back before the next) | Phase 0 | **pending — all three packages ready 2026-09-24** (`PHASE0_HANDOVER.md` §3) |
