-- DA0.2 PRODUCTION RUN SHEET — step P3 (read-only)
...
-- What it does: the same preflight as P1, after P2.
-- Expect: the 19 entity rows and the 664 workers absent; w1536 on 741/185, member of 50 only; every campaign checksum other than 15/37/64 identical to P1; 64 has one membership fewer and identical placements; hygiene_log pending 3139.
-- Paste back: all rows.
